...
public class Green_VN_Zombie extends Entity{
    ...
    static {
        try {
            ...
            zombieMov[0] = ImageIO.read(Green_N_Zombie.class.getResourceAsStream("/Enemies/green_VN_zombie/green_VN_up.png"));
            zombieMov[1] = ImageIO.read(Green_N_Zombie.class.getResourceAsStream("/Enemies/green_VN_zombie/green_VN_down.png"));
            zombieMov[2] = ImageIO.read(Green_N_Zombie.class.getResourceAsStream("/Enemies/green_VN_zombie/green_VN_left.png"));
            zombieMov[3] = ImageIO.read(Green_N_Zombie.class.getResourceAsStream("/Enemies/green_VN_zombie/green_VN_right.png"));

            zombieAttk[0] = ImageIO.read(Green_N_Zombie.class.getResourceAsStream("/Enemies/green_VN_zombie/green_VN_attack_up.png"));
            zombieAttk[1] = ImageIO.read(Green_N_Zombie.class.getResourceAsStream("/Enemies/green_VN_zombie/green_VN_attack_down.png"));
            zombieAttk[2] = ImageIO.read(Green_N_Zombie.class.getResourceAsStream("/Enemies/green_VN_zombie/green_VN_attack_left.png"));
            zombieAttk[3] = ImageIO.read(Green_N_Zombie.class.getResourceAsStream("/Enemies/green_VN_zombie/green_VN_attack_right.png"));
