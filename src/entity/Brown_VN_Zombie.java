...
public class Brown_VN_Zombie extends Entity{
    ...
    static {
        try {
            ...
            zombieMov[0] = ImageIO.read(Green_N_Zombie.class.getResourceAsStream("/Enemies/brown_VN_zombie/brown_VN_up.png"));
            zombieMov[1] = ImageIO.read(Green_N_Zombie.class.getResourceAsStream("/Enemies/brown_VN_zombie/brown_VN_down.png"));
            zombieMov[2] = ImageIO.read(Green_N_Zombie.class.getResourceAsStream("/Enemies/brown_VN_zombie/brown_VN_left.png"));
            zombieMov[3] = ImageIO.read(Green_N_Zombie.class.getResourceAsStream("/Enemies/brown_VN_zombie/brown_VN_right.png"));

            zombieAttk[0] = ImageIO.read(Green_N_Zombie.class.getResourceAsStream("/Enemies/brown_VN_zombie/brown_VN_attack_up.png"));
            zombieAttk[1] = ImageIO.read(Green_N_Zombie.class.getResourceAsStream("/Enemies/brown_VN_zombie/brown_VN_attack_down.png"));
            zombieAttk[2] = ImageIO.read(Green_N_Zombie.class.getResourceAsStream("/Enemies/brown_VN_zombie/brown_VN_attack_left.png"));
            zombieAttk[3] = ImageIO.read(Green_N_Zombie.class.getResourceAsStream("/Enemies/brown_VN_zombie/brown_VN_attack_right.png"));
    ...
    public Brown_VN_Zombie(GamePanel gp, Player player, int X, int Y, int speed, int health, int attack_damage)
    {
        this.gp = gp;
        this.player = player;
        screenPos = new Point();
