...
public class Green_B_Zombie extends Entity{
    ...
    static {
        try {
            ...
            zombieMov[0] = ImageIO.read(Green_N_Zombie.class.getResourceAsStream("/Enemies/green_B_zombie/green_B_zombie_up.png"));
            zombieMov[1] = ImageIO.read(Green_N_Zombie.class.getResourceAsStream("/Enemies/green_B_zombie/green_B_zombie_down.png"));
            zombieMov[2] = ImageIO.read(Green_N_Zombie.class.getResourceAsStream("/Enemies/green_B_zombie/green_B_zombie_left.png"));
            zombieMov[3] = ImageIO.read(Green_N_Zombie.class.getResourceAsStream("/Enemies/green_B_zombie/green_B_zombie_right.png"));

            zombieAttk[0] = ImageIO.read(Green_N_Zombie.class.getResourceAsStream("/Enemies/green_B_zombie/green_B_zombie_attack_up.png"));
            zombieAttk[1] = ImageIO.read(Green_N_Zombie.class.getResourceAsStream("/Enemies/green_B_zombie/green_B_zombie_attack_down.png"));
            zombieAttk[2] = ImageIO.read(Green_N_Zombie.class.getResourceAsStream("/Enemies/green_B_zombie/green_B_zombie_attack_left.png"));
            zombieAttk[3] = ImageIO.read(Green_N_Zombie.class.getResourceAsStream("/Enemies/green_B_zombie/green_B_zombie_attack_right.png"));
    ...
    public Green_B_Zombie(GamePanel gp, Player player, int X, int Y, int speed, int health, int attack_damage)
    {
        this.gp = gp;
        this.player = player;
        screenPos = new Point();
